...
#sheet_name_to_read = "Listing"
#df =pd.read_excel("/Users/mugzi/Downloads/Download as of 26-09-2023.xlsx", sheet_name=sheet_name_to_read)
...
filtered_df_3 = df[
    df['Age'].between(0, 19) & (df["OVC_SERV(1 Yes, 0 No)"] == 1) & (df["Currently Enrolled in School (Y/N)"] == "Yes")
]
...
# Assuming color_format is your color formatting function
